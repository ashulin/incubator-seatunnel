...
public class KuduSink<IN> implements Sink<IN, Void, Void, Void> {
    @Override
    public SinkWriter<IN, Void, Void> createWriter(InitContext context, List<Void> states) throws IOException {
        return null;
    }
